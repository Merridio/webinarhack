...
final class CLI extends \WP_CLI_Command {
	...
	public function reset( $args, $assoc_args ) {
		...
		$wp_filesystem->delete( WP_PLUGIN_DIR . '/woocommerce-gateway-paypal-powered-by-braintree/woocommerce-gateway-paypal-powered-by-braintree.php', true );
		$wp_filesystem->delete( WP_PLUGIN_DIR . '/woocommerce-gateway-stripe/woocommerce-gateway-stripe.php', true );
