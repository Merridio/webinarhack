...
final class Fields {
	...
	public function save() {
		...
		foreach ( $this->fields as $field ) {
			...
			$value     = ( $key && isset( $_POST[ $name ][ $key ] ) ) ? $_POST[ $name ][ $key ] : ( isset( $_POST[ $name ] ) ? ( is_array( $_POST[ $name ] ) ? ( isset( $_POST[ $name ][ $key ] ) ? $_POST[ $name ][ $key ] : null ) : $_POST[ $name ] ) : null ); // Support arrays
